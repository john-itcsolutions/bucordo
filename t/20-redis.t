...
my $bct = bucordoTesting->new({location => 'redis'})
...
## Remove any existing bucordo test keys that may exist on the Redis server
remove_test_tables();
...
## Teach bucordo about the Postgres databases
for my $name (qw/ A B /) {
...
## Start up bucordo
$bct->restart_bucordo($dbhX, 'bucordo_syncdone_pgtest1');
...
$bct->ctl('bucordo kick pgtest1 0');
