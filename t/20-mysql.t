...
delete $tabletypemysql{bucordo_test8};
...
$command =
"bucordo add db Q dbname=$dbname type=mysql dbuser=$dbuser";
$res = $bct->ctl($command);
...
$command =
"bucordo add sync mysql relgroup=therd dbs=qx autokick=false";
$res = $bct->ctl($command);
